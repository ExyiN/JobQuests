...
public class JobsForQuestsGui implements InventoryHolder, JQGui {
    private final JobQuests jobQuests;
    private final Inventory inventory;
    private final UUID playerUuid;

    public JobsForQuestsGui(JobQuests jobQuests, UUID playerUuid) {
    ...
    public Inventory getOnClickInventory(UUID uuid, int slot) {
        QuestsGui questsGui = new QuestsGui(jobQuests, this, uuid, jobQuests.getGuiConfig().getJobGuiSlot().get(slot));
        return questsGui.getInventory();
    }
}
